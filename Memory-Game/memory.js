  ...
  if (showallcardsmode == true) {
    ...
    if (arrayOfCardIds.includes(idOfClickedCard)) {
      if (idOfClickedCard != firstCardRevealed && CardRevealed != 2) {
        ...
        var cardClickedMatchedAudioEasteregg = new Audio('../Memory-Game/Audio/durbaca_nice_idea.mp3');
        var cardClickedNotMatchedAudioEasteregg = new Audio('../Memory-Game/Audio/durbaca_a.mp3');
        if (peppa == 0) {
        ...
        if (CardRevealed == 2) {
          ...
          if (imageNameOffFirstCard == imagesNameOffSecondCard) {
            if(peppa != 0){
              ...
              cardClickedMatchedAudioEasteregg.volume = 0.4;
            }
